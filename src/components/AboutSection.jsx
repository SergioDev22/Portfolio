        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-1 gap-6 max-md:mx-3">
            <div className="gradient-border p-6 card-hover">
              <Motion.div  initial={{x:400, opacity:0}} whileInView={{x:0, opacity:1}} transition={{duration:0.5}}  viewport={{once:true}} className="flex items-start gap-4">
            ...
            <Motion.div  initial={{x:400}} whileInView={{x:0, opacity:1}} transition={{duration:0.5}} viewport={{once:true}} className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                <div className="p-3 rounded-full bg-primary/10">
